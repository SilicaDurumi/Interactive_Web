...
class App {
  constructor() {
    ...
    this.image.src = 'https://images.unsplash.com/photo-1606863234151-1cc9eef8c958?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80';
    this.image.onload = () => {
      this.isLoaded = true;
      this.drawImage();
    };
  ...
  drawImage(){
    ...
    drawDots() {
      ...
      this.rows = Matc.ceil(this.stageHeight / this.pixelSize);
